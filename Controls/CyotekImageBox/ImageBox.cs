...
namespace Cyotek.Windows.Forms
{
    ...
    public class ImageBox : VirtualScrollableControl
    {
        ...
        private bool _disposeImageBeforeChange;
        ...
        /// <summary>
        ///   Gets or sets a value indicating whether the current image should be automatically disposed when the image changes.
        /// </summary>
        /// <value>
        ///   <c>true</c> if the current image should be disposed of before a new image is set / shown; otherwise, <c>false</c>.
        /// </value>
        [DefaultValue(true)]
        [Category("Behavior")]
        public virtual bool DisposeImageBeforeChange
        {
            get { return _disposeImageBeforeChange; }
            set
            {
                if (_disposeImageBeforeChange != value)
                {
                    _disposeImageBeforeChange = value;
                }
            }
        }
        ...
        /// </summary>
        /// <value>
        ///   The button used to make a selection.
        /// </value>
        [Category("Behavior")]
        [DefaultValue(typeof(MouseButtons), "Right")]
        public MouseButtons SelectionButton;

        /// <summary>
        ///   Gets or sets the button used to pan the image.
        /// </summary>
        /// <value>
        ///   The button used to pan the image.
        /// </value>
        [Category("Behavior")]
...
/*        public virtual void RefreshGifAnimation()
        ...
        {
            if (this.SelectionMode == ImageBoxSelectionMode.None || this.WasDragCancelled)
                return;
