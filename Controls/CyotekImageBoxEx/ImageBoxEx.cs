    ...
    public class ImageBoxEx : ImageBox
    {
        ...
        private void ProcessSelectionMove(Point cursorPosition)
        {
            if (this.IsMoving)
            {
                ...
                x = imagePoint.X - this.DragOriginOffset.X;
                y = imagePoint.Y - this.DragOriginOffset.Y;
        ...
        private void ProcessSelectionResize(Point cursorPosition)
        {
            if (this.IsResizing)
            {
                ...
                if (resizingTopEdge)
                {
                    ...
                    if (this.LimitSelectionToImage && top < 0)
                    {
                        top = 0;
                    }
                ...
                else if (resizingBottomEdge)
                {
                    ...
                    if(this.LimitSelectionToImage && bottom > this.ViewSize.Height)
                    {
                ...
                if (resizingLeftEdge)
                {
                    ...
                    if(this.LimitSelectionToImage && left < 0)
                    {
                        left = 0;
                    }
                ...
                else if (resizingRightEdge)
                {
                    ...
                    if(this.LimitSelectionToImage && right > this.ViewSize.Width)
                    {
